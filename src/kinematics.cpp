...
// TES mesures
float wheelDiameter_mm = 58.8;   // rayon 3cm -> diamètre 6cm = 60mm
float trackWidth_mm    = 93.8;  // entraxe 21.3cm = 213mm
long  ticksPerRev      = 42;   // 1 tour de roue = 2292 ticks (mesuré)
