...
//   applyMotorOutputs(Lspeed, Rspeed); 
// }

// void Motors::backward(float Lspeed, float Rspeed) {
//     applyMotorOutputs(-Lspeed, -Rspeed);
// }

// void Motors::rotateRight(float Lspeed, float Rspeed) {
//     applyMotorOutputs(-Lspeed, Rspeed);
// } 

// void Motors::rotateLeft(float Lspeed, float Rspeed) {
//     applyMotorOutputs(Lspeed, -Rspeed);
// }
