...
TABLE_H_MM = 2000
ARUCO_INSET_MM = 500
ARUCO_MARKER_SIZE_MM: float | None = None
...
# Activer/desactiver la detection QR (couteuse en CPU).
ENABLE_QR_DETECTION = False
# Frequence de mise a jour de la vue aerienne (1 = chaque frame, 4 = 1 sur 4).
AERIAL_UPDATE_INTERVAL = 4
